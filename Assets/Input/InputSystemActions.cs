...
public partial class @InputSystemActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSystemActions()
    {
        UnityEngine.Debug.Assert(!m_Tank.enabled, "This will cause a leak and performance issues, InputSystemActions.Tank.Disable() has not been called.");
    ...
    public struct TankActions
    {
        ...
        public TankActions(@InputSystemActions wrapper) { m_Wrapper = wrapper; }
